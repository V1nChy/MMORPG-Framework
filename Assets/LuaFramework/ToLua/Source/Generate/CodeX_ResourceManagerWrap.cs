...
public class CodeX_ResourceManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(CodeX.ResourceManager), typeof(GFW.ManagerSystem.Manager));
	...
	static int DoStart(IntPtr L)
	{
		try
		{
			...
			CodeX.ResourceManager obj = (CodeX.ResourceManager)ToLua.CheckObject<CodeX.ResourceManager>(L, 1);
			obj.DoStart();
			return 0;
		}
		catch (Exception e)
	...
	static int LoadPrefab(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: CodeX.ResourceManager.LoadPrefab");
			}
		}
		catch (Exception e)
		{
	...
	static int UnloadAssetBundle(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: CodeX.ResourceManager.UnloadAssetBundle");
			}
		}
		catch (Exception e)
		{
