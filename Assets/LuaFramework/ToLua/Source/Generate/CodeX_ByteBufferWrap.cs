...
public class CodeX_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(CodeX.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateCodeX_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateCodeX_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				CodeX.ByteBuffer obj = new CodeX.ByteBuffer();
			...
			else if (count == 1)
			{
				...
				CodeX.ByteBuffer obj = new CodeX.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: CodeX.ByteBuffer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			CodeX.ByteBuffer obj = (CodeX.ByteBuffer)ToLua.CheckObject<CodeX.ByteBuffer>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
