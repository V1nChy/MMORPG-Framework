...
public class CodeX_TimerManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(CodeX.TimerManager), typeof(GFW.ManagerSystem.Manager));
	...
	static int StartTimer(IntPtr L)
	{
		try
		{
			...
			CodeX.TimerManager obj = (CodeX.TimerManager)ToLua.CheckObject<CodeX.TimerManager>(L, 1);
	...
	static int AddTimerEvent(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			CodeX.TimerManager obj = (CodeX.TimerManager)ToLua.CheckObject<CodeX.TimerManager>(L, 1);
			CodeX.TimerInfo arg0 = (CodeX.TimerInfo)ToLua.CheckObject<CodeX.TimerInfo>(L, 2);
	...
	static int get_Interval(IntPtr L)
	{
		...
		try
		{
			...
			CodeX.TimerManager obj = (CodeX.TimerManager)o;
