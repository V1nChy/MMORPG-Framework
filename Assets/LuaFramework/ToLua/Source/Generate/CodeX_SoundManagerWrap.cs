...
public class CodeX_SoundManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(CodeX.SoundManager), typeof(GFW.ManagerSystem.Manager));
	...
	static int LoadAudioClip(IntPtr L)
	{
		try
		{
			...
			CodeX.SoundManager obj = (CodeX.SoundManager)ToLua.CheckObject<CodeX.SoundManager>(L, 1);
