...
{
    public static string luaDir = System.Environment.CurrentDirectory + "/Lua";                //lua逻辑代码目录
    public static string toluaDir = System.Environment.CurrentDirectory + "/Lua/tolua";        //tolua lua文件目录
    public static string toluaCSDir = Application.dataPath + "/LuaFramework/Tolua";//Tolua C#代码目录
