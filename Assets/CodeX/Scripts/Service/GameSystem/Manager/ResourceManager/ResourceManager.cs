...
namespace CodeX
{
    public class ResourceManager : Manager {
        ...
        private void Initialize() {
            m_BaseDownloadingURL = AppUtil.GetRelativePath();
            string url = string.Format("{0}{1}", m_BaseDownloadingURL, AppConst.StreamingAssets);
            WWW download;
            ...
            {
                download = WWW.LoadFromCacheOrDownload(url, AppUtil.RandomNum(10000, 99999));
            }
            else
            {
            ...
            {
                UnityEngine.Object request = download.assetBundle.LoadAsset("AssetBundleManifest", typeof(AssetBundleManifest));
                this.m_AssetBundleManifest = (request as AssetBundleManifest);
                m_AllManifest = m_AssetBundleManifest.GetAllAssetBundles();
                this.Log("ResourceManager Initialize Succeed");
            }
            else
            {
                this.LogError("ResourceManager Initialize Fail");
            }
        }
