...
namespace CodeX
{
    public class LuaManager : ManagerModule
    {
        ...
        public override void Awake(MonoBehaviour mono)
        {
            ...
            LuaCoroutine.Register(lua, m_Mono);
        }
        ...
        void InitLuaPath() {
            if (AppConst.DebugMode) {
                ...
                lua.AddSearchPath(AppUtil.DataPath + "lua");
            }
        }
        ...
        public void StartModule(string modName, string startFunc = "Start")
        {
            ...
            LuaFunction luaFunc = lua.GetFunction(modName+"."+ startFunc);
            luaFunc.Call();
            luaFunc.Dispose();
            luaFunc = null;
